...
if 0:
    ...
    pcd_od3.points = o3d.utility.Vector3dVector(input_points[:, 0:3])
    pcd_od3.normals = o3d.utility.Vector3dVector(input_normals[:, 0:3])
    o3d.io.write_point_cloud(save_rescale_point_path, pcd_od3)
    
    fout = open(save_rescale_mesh_path, 'w')
